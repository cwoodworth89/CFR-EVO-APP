...
- `briefings/`: one decision or investigation per file. Snapping to the addressed street, base-site rows, the PA tone discriminator, retiring the confidence score, persisting the response type, the roads status filter, which cross-round disagreements matter, how a recording becomes a Whisper training pair, the review of the Valhalla proposal, and the two audits ([2026-08-30 skills](briefings/skills_audit_2026-08-30.md), [2026-09-03 staleness](briefings/staleness_audit_2026-09-03.md)), and [what the first harness baselines pointed at](briefings/harness_tails_2026-09-05.md) (2026-09-05). [The mobile accessibility review](briefings/mobile_accessibility_review.md) (2026-09-09) is a review and a gated plan, nothing built: what the console and the dispatch display do at phone, tablet and touch-kiosk sizes, measured on the built bundle, and the questions the plan waits on.
