...
**21 open** (16 crew-visible) · **83 closed** → [`punchlist/_closed.md`](punchlist/_closed.md)
...
|:--|:--|:--|:--|
| **94** | 🔴 crew-visible | OPEN — reported 2026-09-17 with a screenshot; with frontend-kiosk-architect to trace the state, then make the saved point the call's target on screen | [A saved arrival point is dropped from the call on screen when the editor closes](punchlist/94-a-saved-arrival-point-is-dropped-from-the-call-on-screen-when-the-editor-closes.md) |
