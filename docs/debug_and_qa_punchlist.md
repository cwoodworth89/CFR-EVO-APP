...
|:--|:--|:--|:--|
| **93** | 🟠 operational | RULED 2026-09-16 — option A (metadata request per call, aim at the lot centre): "Let's get A going because it's a crew facing issue." Amended: with no heading, Expand still opens the nearest panorama and a view can be saved. With frontend-kiosk-architect; billing to be verified before building | [The Street View tile faces due north on every call with no saved view](punchlist/93-the-street-view-tile-faces-due-north-on-every-unsaved-call.md) |
