...
|:--|:--|:--|:--|
| **93** | 🟠 operational | OPEN — measured 2026-09-16: heading is 0 (due north) on every unsaved call, 46% of recent parcel calls face away; two fixes and two domain questions for the operator, nothing built | [The Street View tile faces due north on every call with no saved view](punchlist/93-the-street-view-tile-faces-due-north-on-every-unsaved-call.md) |
