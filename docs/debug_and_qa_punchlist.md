...
| **79** | 🔴 crew-visible | FIXED, migrations applied; awaiting agent restart | [A venue talk group loses to channel 10, and the venue's name in the vocabulary was wrong](punchlist/79-a-venue-talk-group-loses-to-channel-10-on-list-order.md) |
