...
### 2.5 Passwordless Service Restarts (For Remote/CI/CD Deployment)
...
1. Open the sudoers configuration on the kiosk:
   ...
   sudo visudo
   ```
2. Append the following rule to the bottom of the file (replace `pi`/`tcfire` with your actual username):
   ```text
