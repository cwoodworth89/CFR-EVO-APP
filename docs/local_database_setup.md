...
CREATE INDEX IF NOT EXISTS idx_dispatches_timestamp ON public.dispatches (timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_dispatches_feedback ON public.dispatches (feedback_submitted, verify_location);
```
