...
| | |
|:--|:--|
| **Status** | BUILT — backend `ad339fec`, frontend `727c297b`; **not deployed, nothing live verified.** Needs the api rebuild and a frontend build on the kiosk, then the falsifier below |
