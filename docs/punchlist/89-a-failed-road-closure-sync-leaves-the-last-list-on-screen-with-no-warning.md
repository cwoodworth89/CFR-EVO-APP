...
| | |
|:--|:--|
| **Status** | BACKEND BUILT `ad339fec` (pieces 1–2); frontend half in progress; **api not rebuilt** — the response shape change is breaking, so both halves deploy together |
