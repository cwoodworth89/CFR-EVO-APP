...
| | |
|:--|:--|
| **Status** | BUILT — backend `e3009d6a`, frontend `2978da7e`; **not deployed.** Card placement ruled 2026-09-16, follow-up with `frontend-kiosk-architect`. Latent: falsifier run on the kiosk, 177 rows, 0 null, 0 malformed |
