...
| | |
|:--|:--|
| **Status** | DEPLOYED 2026-09-16 20:07Z, confirmed on the kiosk (HEAD `0d17989a`, migration, bundle and api all in). First sync forced 20:08Z: 67 of 71 active closures N/A. **Open:** ERROR log volume (141 lines / 3 min, measured); the admin panel row (with `frontend-kiosk-architect`); the DriveBC pass-through question, now with the verified vocabulary |
