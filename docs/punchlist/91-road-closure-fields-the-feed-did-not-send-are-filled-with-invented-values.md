...
| | |
|:--|:--|
| **Status** | BUILT — backend `ea6151b9`, frontend `776b52e5`, with a migration that **must run before the api rebuild**; **not deployed, migration not yet run on Postgres, nothing seen rendered.** Text placeholders unruled and untouched; three follow-on rulings below |
