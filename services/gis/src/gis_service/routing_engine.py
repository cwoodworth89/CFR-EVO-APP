...
APPARATUS_TIERS: Dict[str, Dict[str, Any]] = {
    "light": {
        ...
        "weight_tons": 5,
        "speed_emergency_kmh": 52.0,
        "speed_routine_kmh": 38.0,
        "road_factor_emergency": 1.25,
        "road_factor_routine": 1.35,
    ...
    "general": {
        ...
        "weight_tons": 22,
        "speed_emergency_kmh": 45.0,
        "speed_routine_kmh": 32.0,
        "road_factor_emergency": 1.35,
        "road_factor_routine": 1.45,
    ...
    "heavy": {
        ...
        "weight_tons": 35,
        "speed_emergency_kmh": 38.0,
        "speed_routine_kmh": 28.0,
        "road_factor_emergency": 1.45,
        "road_factor_routine": 1.55,
